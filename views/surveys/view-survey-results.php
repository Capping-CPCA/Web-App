	...
	<div style="width: 100%;">
		...
		<?php
			function updateDB(){
				...
				if ($surveyConfig['password'] != "") {
					$output = shell_exec('C:/Python27/Python ../views/surveys/pullAndParseSurveys.py '
					...
					$output = System('C:/Python27/Python ../views/surveys/pullAndParseSurveys.py '
						. $surveyConfig['database'] . ' ' . $surveyConfig['username'] . ' "" ' . $surveyConfig['address'] . ' '
						. $surveyConfig['googleEmail'] . ' ' . $surveyConfig['googlePassword']);
				}
				...
				shell_exec('echo %DATE% %time% > ../views/surveys/Timesheet.txt');
            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-sm" style="max-width:75%; position: absolute; bottom: 5%;">
                        ...
                        <h6 style="font-size: 15px; color: darkGray;" id="result"></p>
					<?php
					if (file_exists('../views/surveys/Timesheet.txt')) {
						$command = file_get_contents('../views/surveys/Timesheet.txt'); 
						echo $command;
					} else {
						echo "Never";
					}
