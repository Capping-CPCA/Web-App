                        ...
                        <div class="card">
                            ...
                            <div id="collapse1" class="collapse show" role="tabpanel">
                                <div class="card-body">
                                    ...
                                    <!-- End Handicap/Medication -->

                                    <h5>Contact Information</h5>
                                    <br>
                                    <!-- Begin Street Address -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 col-3" for="intake_address">Street Address:</label>
                                        <div class="col-sm-4 col">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 col-3" for="intake_apt_info">Apartment:</label>
                                    ...
                                    <!-- Begin City-->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 col-3" for="intake_city">City:</label>
                                        <div class="col-sm-4 col-4">
                                    ...
                                    <!-- Begin State -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="intake_state">State:</label>
                                        <div class="col-sm-4">
                                    ...
                                    <!-- Begin Zip -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="intake_zip">ZIP:</label>
                                    ...
                                    <!-- Begin Daytime Phone/Leave Message-->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="intake_phone_day">Daytime Phone:</label>
                                    ...
                                    <!-- End Daytime Phone/Leave Message -->

                                    <!-- Begin Evening Phone -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="intake_phone_night">Evening Phone:</label>
                                        <div class="col-sm-3 col">
                                    ...
                                    <!-- Begin Relationship -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label col-3" for="contact_relationship">Relationship:</label>
                                        <div class="col-sm-4 col">
                                    ...
                                    <!-- Begin Phone Number -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3 col-3" for="contact_phone">Phone Number:</label>
                                        <div class="col-sm-3 col">
                            ...
                            <div id="collapse2" class="collapse">
                                <div class="card-body">
                                    <div id="childEntry_1" class="clonedChild">
                                        ...
                                        <!-- Begin date of birth -->
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label label_dob" for="child_dob_1">Date of Birth:</label>
                                            <div class="col-sm-4 col">
                                        ...
                                        <!-- Begin Residence -->
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label label_live">Residence:</label>
                                        ...
                                        <!-- Begin custody -->
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label label_custody">Custody:</label>
                                            <div class="col-sm-6 col">
                                    ...
                                    <div class="form-group row controls">
                                        <label class="col-sm-3 col-form-label">Add Child:</label>
                                    ...
                                    <!-- Begin Remove Child -->
                                    <div class="form-group row controls">
                                        <label class="col-sm-3 col-form-label">Remove Child:</label>
                                        <div class="col-sm-1 col">
                                ...
                                <div class="card-body" align="left">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-8 col-8">
                                            <input type="text" class="form-control" id="class_participation" name="class_participation" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 col-8">
                                            <input type="text" class="form-control" id="parenting_opinion" name="parenting_opinion" placeholder="">
                                        </div>
                                    </div>
                                    <!-- End Parenting -->
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-8 col-8">
                                            <input type="text" class="form-control" id="class_takeaway" name="class_takeaway" placeholder="">
                                        </div>
                                    </div>
                                    <!-- End Class Takeaway -->
